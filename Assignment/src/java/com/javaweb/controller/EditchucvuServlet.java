 ...
 * @author Admin
 */
public class EditchucvuServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Chucvu cv = ad.getChucvuByID(idchucvu);
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet EditchucvuServlet</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet EditchucvuServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
